          ...
          <View style={styles.teamsList}>
            {teams.map((team) => (
              ...
              >
                ...
                {selectedTeamId === team.id && <Ionicons name="checkmark-circle" size={22} color={colors.primary} />}
              </TouchableOpacity>
            ))}
          </View>
        </View>
        ...
        <View style={styles.stepContent}>
          ...
          {!isSquadCommanderOnly && (
            <TouchableOpacity
              style={[
                styles.squadToggle,
                { backgroundColor: colors.card, borderColor: assignToSquad ? colors.primary : colors.border },
              ]}
              onPress={() => {
                Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                if (assignToSquad) {
            ...
            >
              <View style={styles.squadToggleLeft}>
                <View
                  style={[
                    styles.squadToggleIcon,
                    { backgroundColor: assignToSquad ? colors.primary + '15' : colors.secondary },
                  ]}
                >
            ...
            <View style={[styles.squadSection, { backgroundColor: colors.card, borderColor: colors.border }]}>
                  ...
                  <View style={styles.squadChips}>
                    {squadsList.map((squad: string) => (
                      <TouchableOpacity
                        ...
                        activeOpacity={0.7}
                      >
                        <Ionicons name="shield" size={12} color={squadName === squad ? '#fff' : colors.text} />
              ...
              <View style={styles.squadInputSection}>
                ...
                <View
                  style={[
                    styles.inputWrapper,
                    { backgroundColor: colors.background, borderColor: squadName ? colors.primary : colors.border },
                  ]}
                >
                  <TextInput
                  ...
                  />
                  {squadName.trim() && (
                    <TouchableOpacity style={styles.clearInputBtn} onPress={() => setSquadName('')}>
              ...
              {squadName.trim() && (
                <TouchableOpacity
                  style={[
                    ...
                    { backgroundColor: colors.background, borderColor: makeSquadCommander ? '#10B981' : colors.border },
                  ]}
                  onPress={() => {
                    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                ...
                >
                  <View style={styles.commanderLeft}>
                    <View
                      style={[
                        styles.commanderIcon,
                        { backgroundColor: makeSquadCommander ? '#10B98115' : colors.secondary },
                      ]}
                    >
          ...
          {!isSquadCommanderOnly && (
            <TouchableOpacity
              style={[
                styles.squadToggle,
                { backgroundColor: colors.card, borderColor: assignWeapon ? colors.green : colors.border },
              ]}
              onPress={() => {
                Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                if (assignWeapon) {
            ...
            >
              <View style={styles.squadToggleLeft}>
                <View
                  style={[
                    styles.squadToggleIcon,
                    { backgroundColor: assignWeapon ? colors.green + '15' : colors.secondary },
                  ]}
                >
                ...
                <View style={styles.weaponsList}>
                  {teamWeapons.map((weapon) => (
                    ...
                    >
                      <View
                        style={[
                          styles.weaponIconBox,
                          { backgroundColor: selectedWeaponId === weapon.id ? colors.green + '20' : colors.secondary },
                        ]}
                      >
