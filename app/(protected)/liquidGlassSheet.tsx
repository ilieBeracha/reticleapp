...
import WorkspaceItem from "@/components/modals/WorkspaceItem";

export interface LiquidGlassSheetRef {
  open: () => void;
  close: () => void;
}
...
export const LiquidGlassSheet = forwardRef<LiquidGlassSheetRef, LiquidGlassSheetProps>(
  (props, ref) => {
     ...
     * Sets store and navigates to /(protected)/org
     */
    const handleSelectWorkspace = useCallback(async (workspace: Workspace) => {
      try {
        ...
        // Navigate to org route (store has the active workspace)
    ...
    const handleCreateWorkspace = useCallback(async () => {
      ...
      try {
        ...
        // Navigate to the new workspace (store already set above)
        router.replace('/(protected)/org' as any);
...
export default function LiquidGlassSheetScreen() {
