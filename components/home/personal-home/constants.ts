import { Calendar, Crosshair, ScanLine, Target, Timer, TrendingUp } from 'lucide-react-native';
...
export const ACTIVE_DIAL_MODES: Record<ActiveDialMode, DialModeConfig> = {
  time: {
    ...
    icon: Timer,
    color: '#F59E0B',
    getProgress: (v, _) => Math.min(v / 60, 1),
  },
  targets: {
    key: 'targets',
    label: 'TARGETS',
...
export const ACTIVE_MODES_ORDER: ActiveDialMode[] = ['time', 'targets', 'shots', 'accuracy'];
