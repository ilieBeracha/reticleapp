...
const buttonStyle = tva({
  ...
  variants: {
    action: {
      primary:
        "bg-primary-500  border-primary-700 data-[hover=true]:border-primary-400 data-[active=true]:border-primary-500 data-[focus-visible=true]:web:ring-indicator-info",
      secondary:
...
const buttonTextStyle = tva({
  ...
  parentCompoundVariants: [
    ...
    },
    {
      ...
      action: "primary",
      class:
        "text-primary-700 data-[hover=true]:text-primary-500 data-[active=true]:text-primary-500",
    },
    {
      variant: "outline",
      action: "secondary",
