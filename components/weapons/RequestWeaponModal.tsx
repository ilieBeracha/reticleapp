...
export function RequestWeaponModal({
  visible,
  teamId,
  onClose,
  onSuccess,
}: RequestWeaponModalProps) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      Alert.alert(
        'Request Failed',
        err.message || 'Could not submit weapon request. Please try again.'
      );
    } finally {
      setSubmitting(false);
    }
      ...
      >
        ...
        >
          ...
          <Text style={[styles.instructions, { color: colors.textMuted }]}>
            Submit a request to your commander for a weapon assignment.
            You can optionally specify your preferred weapon category.
          </Text>
