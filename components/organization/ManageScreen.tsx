...
const styles = StyleSheet.create({
  ...
  memberTeam: { fontSize: 12, marginTop: 1 },

  // Attached Card
  attachedCard: { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, paddingHorizontal: 16, marginBottom: 8, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, gap: 12 },
  attachedInfo: { flex: 1, gap: 2 },
  attachedName: { fontSize: 16, fontWeight: '500' },
  attachedEmail: { fontSize: 13 },
  attachedMeta: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 2 },
  attachedMetaText: { fontSize: 12 },

  // Team Card
  teamCard: { marginBottom: 8, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, overflow: 'hidden' },
  teamCardHeader: { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, paddingHorizontal: 16, gap: 12 },
  ...
  teamMembersList: { borderTopWidth: StyleSheet.hairlineWidth, paddingVertical: 8, paddingHorizontal: 16 },
  ...
  teamHeader: { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, paddingHorizontal: 16, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, gap: 12, marginBottom: 8 },
  teamHeaderIcon: { width: 44, height: 44, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  teamHeaderInfo: { flex: 1, gap: 2 },
  teamHeaderName: { fontSize: 18, fontWeight: '600' },
  ...
  teamCardIcon: { width: 32, height: 32, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  teamCardInfo: { flex: 1, gap: 2 },
  teamCardName: { fontSize: 15, fontWeight: '500' },
  teamCardCount: { fontSize: 13 },

  // Invite Button
  inviteTeamBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 14, marginTop: 8, borderRadius: 12, borderWidth: 1, borderStyle: 'dashed', gap: 6 },
  inviteTeamBtnText: { fontSize: 14, fontWeight: '600' },

  // Invite Card
  inviteCard: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 16, marginBottom: 8, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, gap: 10 },
  ...
  youBadgeSmall: { paddingHorizontal: 5, paddingVertical: 2, borderRadius: 4 },
  youBadgeSmallText: { fontSize: 8, fontWeight: '700', color: '#fff' },

  // No Team
  noTeamContainer: { alignItems: 'center', paddingVertical: 50, gap: 12 },
  noTeamText: { fontSize: 15 },

  // Empty State
  emptyState: { alignItems: 'center', paddingVertical: 32, paddingHorizontal: 24, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth },
  emptyIconBox: { width: 56, height: 56, borderRadius: 28, alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  emptyTitle: { fontSize: 17, fontWeight: '600', marginBottom: 4, textAlign: 'center' },
  emptyDesc: { fontSize: 14, textAlign: 'center', lineHeight: 20, marginBottom: 16 },
  emptyAction: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, paddingHorizontal: 16, borderRadius: 8, gap: 6 },
